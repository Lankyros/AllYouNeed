...
<form method="post">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" id="usarDatosCli">
        ...
        ?>
            <div class="mt-5 text-center">
                Debe <a href="login.php">Iniciar Sesion</a> o <a href="registro.php">Registrarse</a> para poder continuar
            </div>
        <?php
    }
?>